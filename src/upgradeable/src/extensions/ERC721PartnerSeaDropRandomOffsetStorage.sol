...
import { ERC721PartnerSeaDropRandomOffsetUpgradeable } from "./ERC721PartnerSeaDropRandomOffsetUpgradeable.sol";
...
library ERC721PartnerSeaDropRandomOffsetStorage {
  ...
  bytes32 internal constant STORAGE_SLOT = keccak256('openzepplin.contracts.storage.ERC721PartnerSeaDropRandomOffset');
