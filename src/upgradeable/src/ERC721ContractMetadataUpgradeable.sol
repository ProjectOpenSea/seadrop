...
function c_true1396a104(bytes8 c__1396a104) pure returns (bool) {
    return true;
}

function c_false1396a104(bytes8 c__1396a104) pure returns (bool) {
    return false;
}
    ...
    ISeaDropTokenContractMetadataUpgradeable
{
    ...
    function c_true723b74af(bytes8 c__723b74af) internal pure returns (bool) {
        return true;
    }

    function c_false723b74af(bytes8 c__723b74af) internal pure returns (bool) {
        return false;
    }

    modifier c_mod83167949() {
        c_723b74af(0xe25c5a0972047f35); /* modifier-post */
        _;
    }
    modifier c_mod769268c4() {
        c_723b74af(0xbf20eddb6035ef0b); /* modifier-pre */
        _;
    }
    modifier c_mod88b694a0() {
        c_723b74af(0x20f5f916a051498a); /* modifier-post */
        _;
    }
    modifier c_mod7482c530() {
        c_723b74af(0x9b6a9c882066f1d2); /* modifier-pre */
        _;
    }
    modifier c_modc42362c0() {
        c_723b74af(0x58fa60c41ffbe214); /* modifier-post */
        _;
    }
    modifier c_mod9279af40() {
        c_723b74af(0x4ccb3b51ada937a4); /* modifier-pre */
        _;
    }
    modifier c_mod87f2832d() {
        c_723b74af(0xb123198ad8764f78); /* modifier-post */
        _;
    }
    modifier c_mod15ab1e2a() {
        c_723b74af(0x82f49d4b0188cac4); /* modifier-pre */
        _;
    }
    modifier c_mod975375fe() {
        c_723b74af(0x2c4c4d69ad8668ab); /* modifier-post */
        _;
    }
    modifier c_modc27c632b() {
        c_723b74af(0xf75d27c0ffd73aeb); /* modifier-pre */
        _;
    }
    ...
    function __ERC721ContractMetadata_init_unchained(
        ...
        c_723b74af(0xe2ba647946a42b4b); /* function */
    }
    ...
    function baseURI() external view override returns (string memory) {
        c_723b74af(0xba2d899bed2a4722); /* function */
    ...
    function contractURI() external view override returns (string memory) {
        c_723b74af(0x82974db9815fd426); /* function */
    ...
    function maxSupply() public view returns (uint256) {
        c_723b74af(0xb9eb2077a44aecf6); /* function */
    ...
    function provenanceHash() external view override returns (bytes32) {
        c_723b74af(0x7706a4197c05f008); /* function */
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        c_723b74af(0x3b1c2a688d8980a0); /* function */
